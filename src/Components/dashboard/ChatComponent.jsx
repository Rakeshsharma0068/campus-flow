...
const OpenAIMessage = async (prompt)=>{
    const chatCompletion = await openai.chat.completions.create({
        messages: [{ role: 'user', content: "Your task is to act like a Admin at UTA university and answer the faculty queries in strictly one simple line"+prompt }],
        model: 'gpt-3.5-turbo',
    });
